...
MR_EXAMPLES_JAR=/usr/hdp/4.1.7.5/hadoop-mapreduce/hadoop-mapreduce-examples-3.1.1.4.1.7.5.jar
...
OUTPUT=/user/edgar/${SIZE}-terasort-output
REPORT=/user/edgar/${SIZE}-terasort-report
